...
$LOG = "C:\dev\citiusverse\citiusdata\racefilt_arm_log.txt"
"=== START $(Get-Date) ===" | Out-File -Append -Encoding utf8 $LOG

$env:CITIUS_BT_CALIBRATION   = "calibration_racefilt_min8.rds"
$env:CITIUS_BT_ADJUST_RACE   = "1"
$env:CITIUS_BT_STORE         = "athletics_corpus_store"
$env:CITIUS_BT_CACHE         = "bt_cache_racefilt8"
$env:CITIUS_BT_OUT           = "backtest_racefilt8.rds"
...
for ($i = 1; $i -le 6; $i++) {
  ...
  if (Test-Path "citiusdata\data\backtest_racefilt8.rds") {
    $f = Get-Item "citiusdata\data\backtest_racefilt8.rds"
...
$env:CITIUS_GOAL_ARM = "backtest_racefilt8.rds"
...
Copy-Item "citiusdata\data\goal_by_event.csv" "citiusdata\data\goal_by_event_racefilt8.csv" -Force
