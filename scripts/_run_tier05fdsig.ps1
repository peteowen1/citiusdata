...
$MAX_CHUNKS      = 6
$WORKERS         = 12
$HB  = "C:\dev\citiusverse\citiusdata\data\tier05fdsig_heartbeat.txt"
$LOG = "C:\dev\citiusverse\citiusdata\tier05fdsig_log.txt"

$env:CITIUS_BT_CALIBRATION   = "calibration_corpus_csigma_coast.rds"
$env:CITIUS_BT_STORE         = "athletics_corpus_store"
$env:CITIUS_BT_CACHE         = "backtest_cache_tier05fdsig"
$env:CITIUS_BT_OUT           = "backtest_tier05fdsig.rds"
...
$cacheDir = "C:\dev\citiusverse\citiusdata\data\backtest_cache_tier05fdsig"
