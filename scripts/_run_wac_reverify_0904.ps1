...
#   2. control arm  -- deployed feed-tier calibration, M1 population
...
Write-Host "[2/3] control arm (deployed feed-tier, M1)..."
...
Write-Host "[3/3] treatment arm (WAC meet_tier, M1)..."
